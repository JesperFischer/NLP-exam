...
def run_LDA(data, num_topics, analysis = "abstracts", save_plot = True, file = "LDA_run", bow = True, alpha = "auto"):
   ...
   #plotting
    ...
    if save_plot == True:
        ...
        fig.write_image(os.path.join(os.getcwd(),f"LDA_results/{file}_analysis={analysis}.png"), engine = "auto")
